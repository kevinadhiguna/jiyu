...
console.log(
  `Is ${lowercaseWord} lowercase ?`,
  isLowerCase(lowercaseWord) ? "Yes" : "No.."
); // Is joe lowercase ? Yes
console.log(
  `Is ${uppercaseWord} lowercase ?`,
  isLowerCase(uppercaseWord) ? "Sure" : "Nope.."
); // Is WILLOCK lowercase ? Nope..
